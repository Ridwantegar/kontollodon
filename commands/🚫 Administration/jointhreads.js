    ...
    try {
      ...
      if(!channels || channels.size == 0)        
        return message.reply({embeds: [new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(client.getFooter(es))
          .setTitle(`<:945226710394232852:1167791114883956746>  **There are no open Threads in this Server**`)
        ]}); 
      ...
      message.reply({embeds :[new MessageEmbed()
        .setColor(es.color)
        .setFooter(client.getFooter(es))
        .setTitle(`<:945226678362316841:1167791111184592988>  **I joined \`${channels.size}\` Threads**`)
      ]});

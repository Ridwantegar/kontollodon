...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      return message.reply({content : `**<:945226710394232852:1167791114883956746>  THIS COMMAND IS DISABLED, go to discord.gg/milrato and <#840332764603351101> to get it restarted!**\n\n\n> **Path:**
\`\`\`yml
${process.cwd()}
\`\`\`
> **Server:**

  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      collector.on("collect", async b => {
        ...
        b?.reply(`<:945226678362316841:1167791111184592988>  **\`Enabled ${enabled} Command-Categories\` and \`Disabled ${disabled} Command-Categories\` out of \`${b?.values.length} selected Command-Categories\`**`)
      })

  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<:945226678362316841:1167791111184592988>  Accepted Idea! Expect this soon.`,
          denymsg: `<:945226710394232852:1167791114883956746>  Thank you for the feedback, but we are not interested in this idea at this time.`,

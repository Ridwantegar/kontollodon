...
///////////////////////////////////////
      ...
      if(!message.guild.me.permissions.has(Discord.Permissions.FLAGS.ADMINISTRATOR)){
        return message.reply("<:945226710394232852:1167791114883956746>  **I am missing the ADMINISTRATOR Permission!**")
      }
      ...
      if(owner.id != cmduser.id) {
          return message.reply(`<:945226710394232852:1167791114883956746>  **You need to be the Owner of this Server!**`)
      }
